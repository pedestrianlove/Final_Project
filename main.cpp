...
void game_begin() {
    // Load sound
    song = al_load_sample( "resources/sounds/hello.wav" );
    if (!song){
    ...
    if(window == 1){
        if (!al_is_event_queue_empty(event_queue)) {
            ...
            if(judge_next_window) {
                ...
                character1.image_path = al_load_bitmap("resources/images/tower.png");
                character2.image_path = al_load_bitmap("resources/images/teemo_left.png");
                character3.image_path = al_load_bitmap("resources/images/teemo_right.png");
                background = al_load_bitmap("resources/images/stage.jpg");
